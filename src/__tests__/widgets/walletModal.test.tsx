...
it("renders ConnectModal correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c7:hover:not(:disabled):not(.lydia-button--disabled):not(.lydia-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c7:active:not(:disabled):not(.lydia-button--disabled):not(.lydia-button--disabled) {
      opacity: 0.85;
    ...
    .c12:hover:not(:disabled):not(.lydia-button--disabled):not(.lydia-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c12:active:not(:disabled):not(.lydia-button--disabled):not(.lydia-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
    ...
    .c15:hover:not(:disabled):not(.lydia-button--disabled):not(.lydia-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c15:active:not(:disabled):not(.lydia-button--disabled):not(.lydia-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
      ...
      >
        ...
        >
          ...
          <a
            class="c16 c17 c18"
            color="primary"
            href="https://docs.lydiafinance.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain"
