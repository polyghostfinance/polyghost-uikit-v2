...
it("renders link correctly", () => {
  const { asFragment } = renderWithTheme(<Link href="https://lydiafinance.finance">Link</Link>);
...
it("renders link external link correctly", () => {
  const { asFragment } = renderWithTheme(<LinkExternal href="https://lydiafinance.finance">Link</LinkExternal>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      .c0 {
      color: #1FC7D4;
