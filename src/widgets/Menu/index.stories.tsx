...
const langs: LangLanguageType[] = [...Array(20)].map((_, i) => ({ code: `en${i}`, language: `English${i}` }));
...
const useProps = () => {
  const [props, setProps] = useState({
    ...
    setLang: noop,
    currentLang: "EN",
    lydPriceUsd: 0.023158668932877668,
    links,
    profile: null,
  });
  ...
  return (
    <BrowserRouter>
      <Menu
        ...
        links={links}
        profile={{
          username: "lydiafinance",
          image: "https://lydiafinance.finance/images/nfts/blueberries-preview.png",
          profileLink: "/profile",
          noProfileLink: "/no-profile",
        }}
      >
