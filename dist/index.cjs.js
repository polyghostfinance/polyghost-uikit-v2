...
var Icon$S = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        ...
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("linearGradient", { id: "paint0_linear_lydias", x1: "25.691", y1: "9.6549", x2: "25.691", y2: "40.2608", gradientUnits: "userSpaceOnUse" },
...
var StyledLink = styled__default['default'](Text)(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
...
var LYDToggle = function (_a) {
    ...
    return (React__default['default'].createElement(LydiaStack, { scale: scale },
        React__default['default'].createElement(LydiaInput, __assign({ id: props.id || "lydia-toggle", scale: scale, type: "checkbox", checked: checked }, props)),
        React__default['default'].createElement(LydiaLabel, { scale: scale, checked: checked, htmlFor: props.id || "lydia-toggle" },
            React__default['default'].createElement("div", { className: "lydias" },
                React__default['default'].createElement("div", { className: "lydia" }),
                React__default['default'].createElement("div", { className: "lydia" }),
                React__default['default'].createElement("div", { className: "lydia" }),
...
styled__default['default'](Icon$r)(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("g", { id: "soil-copy" },
            React__default['default'].createElement("path", { id: "Path", d: "M18.079 19.079 C17.825 19.079 17.579 19.111 17.345 19.172 16.992 17.955 15.87 17.065 14.539 17.065 14.286 17.065 14.04 17.098 13.805 17.159 13.452 15.942 12.33 15.052 11 15.052 9.67 15.052 8.548 15.942 8.195 17.159 7.96 17.098 7.714 17.065 7.461 17.065 6.13 17.065 5.008 17.955 4.655 19.172 4.421 19.111 4.175 19.079 3.921 19.079 2.308 19.079 1 20.387 1 22 L21 22 C21 20.387 19.692 19.079 18.079 19.079 Z", "fill-opacity": "1", stroke: "none" }),
            React__default['default'].createElement("path", { id: "Path-1", d: "M11.586 3.172 L13.308 3.172 13.308 2 8.692 2 8.692 3.172 10.414 3.172 10.414 10.26 11.586 10.26 Z", "fill-opacity": "1", stroke: "none" }),
            React__default['default'].createElement("path", { id: "Path-2", d: "M8.52 14.717 C9.238 14.17 10.095 13.88 11 13.88 11.905 13.88 12.762 14.17 13.48 14.717 13.617 14.822 13.745 14.935 13.867 15.055 L14.082 14.824 14.082 10.26 11.586 10.26 11.586 12.375 10.414 12.375 10.414 10.26 7.918 10.26 7.918 14.824 8.133 15.055 C8.255 14.935 8.383 14.822 8.52 14.717 Z", "fill-opacity": "1", stroke: "none" }))));
};
...
var Icon$f = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("g", { id: "hammer-(1)-copy" },
            React__default['default'].createElement("g", { id: "group" },
                React__default['default'].createElement("g", { id: "group-1" },
                    React__default['default'].createElement("path", { id: "Path", d: "M19.538 9.907 L13.571 3.941 C13.473 3.842 13.339 3.786 13.199 3.786 L9.161 3.786 C8.738 3.786 8.341 3.951 8.042 4.25 L7.605 4.686 C7.307 4.985 7.142 5.382 7.142 5.805 7.142 6.228 7.307 6.625 7.605 6.923 L15.063 14.381 C15.68 14.998 16.683 14.999 17.3 14.381 L19.538 12.144 C20.154 11.527 20.154 10.524 19.538 9.907 Z", "fill-opacity": "1", stroke: "none" }))),
            React__default['default'].createElement("g", { id: "group-2" },
                React__default['default'].createElement("g", { id: "group-3" },
                    React__default['default'].createElement("path", { id: "Path-1", d: "M18.573 5.65 L17.828 4.905 C17.629 4.706 17.364 4.597 17.082 4.597 16.8 4.597 16.535 4.706 16.336 4.905 L16.181 5.059 18.419 7.297 18.573 7.142 C18.985 6.731 18.985 6.062 18.573 5.65 Z", "fill-opacity": "1", stroke: "none" }))),
            React__default['default'].createElement("g", { id: "group-4" },
                React__default['default'].createElement("g", { id: "group-5" },
                    React__default['default'].createElement("path", { id: "Path-2", d: "M10.231 11.041 L5.756 15.516 7.993 17.753 12.468 13.278 Z", "fill-opacity": "1", stroke: "none" }))),
            React__default['default'].createElement("g", { id: "group-6" },
                React__default['default'].createElement("g", { id: "group-7" },
                    React__default['default'].createElement("path", { id: "Path-3", d: "M5.01 16.261 L2.308 18.974 C1.898 19.384 1.898 20.054 2.308 20.465 L3.054 21.211 C3.467 21.623 4.133 21.623 4.546 21.211 L7.248 18.498 Z", "fill-opacity": "1", stroke: "none" }))),
            React__default['default'].createElement("g", { id: "group-8" }),
            React__default['default'].createElement("g", { id: "group-9" }),
            React__default['default'].createElement("g", { id: "group-10" }),
            React__default['default'].createElement("g", { id: "group-11" }),
            React__default['default'].createElement("g", { id: "group-12" }),
            React__default['default'].createElement("g", { id: "group-13" }),
            React__default['default'].createElement("g", { id: "group-14" }),
            React__default['default'].createElement("g", { id: "group-15" }),
            React__default['default'].createElement("g", { id: "group-16" }),
            React__default['default'].createElement("g", { id: "group-17" }),
            React__default['default'].createElement("g", { id: "group-18" }),
            React__default['default'].createElement("g", { id: "group-19" }),
            React__default['default'].createElement("g", { id: "group-20" }),
            React__default['default'].createElement("g", { id: "group-21" }),
            React__default['default'].createElement("g", { id: "group-22" }))));
};
...
styled__default['default'](reactRouterDom.Link)(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var LydPrice = function (_a) {
    ...
    return lydPriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://info.lydia.finance/tokens#/token/0x4c9b4e1ac6f24cde3660d5e4ef1ebf77c710c084", target: "_blank" },
        React__default['default'].createElement(Icon$R, { width: "35px", mr: "8px" }),
        React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, " $" + lydPriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
var LYDPrice = React__default['default'].memo(LydPrice);
...
var SocialEntryX = styled__default['default'].div(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  padding: 5px;\n  padding-bottom: 50px;\n"], ["\n  display: flex;\n  flex-direction: column;\n  padding: 5px;\n  padding-bottom: 50px;\n"])));
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(SocialEntry, null,
            React__default['default'].createElement(LYDPrice, { lydPriceUsd: lydPriceUsd })),
        React__default['default'].createElement(SettingsEntry, null,
            React__default['default'].createElement(ThemeSwitcher$1, { isDark: isDark, toggleTheme: toggleTheme }),
            React__default['default'].createElement(SocialEntryX, null,
                React__default['default'].createElement("a", { href: "https://twitter.com/LydiaFinance" },
                    React__default['default'].createElement(Text, { small: true, color: "textSubtle" }, "Twitter")),
                React__default['default'].createElement("a", { href: "https://t.me/LydiaFinance" },
                    React__default['default'].createElement(Text, { small: true, color: "textSubtle" }, "Telegram")),
                React__default['default'].createElement("a", { href: "http://discord.gg/5sBmmVFSqk" },
                    React__default['default'].createElement(Text, { small: true, color: "textSubtle" }, "Discord"))))));
};
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://docs.lydia.finance/guides/how-do-i-set-up-my-wallet-on-avalanche", external: true },
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://cchain.explorer.avax.network/address/" + account, mr: "16px" }, "View on C-Chain AvaxExplorer"),
...
var StyledTitle = styled__default['default'].div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  font-size: 24px;\n  color: ", ";\n  margin: 0px 5px;\n  font-weight: 600;\n"], ["\n  font-size: 24px;\n  color: ", ";\n  margin: 0px 5px;\n  font-weight: 600;\n"])), function (_a) {
    var isDark = _a.isDark;
    return "" + (isDark ? "#fff" : "#000");
});
var StyledMenuLogo = styled__default['default'].div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"], ["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"])));
var StyledImageLogo = styled__default['default'](Image)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  width: 75px;\n  min-width: 50px;\n"], ["\n  width: 75px;\n  min-width: 50px;\n"])));
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(StyledMenuLogo, null,
                React__default['default'].createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
                React__default['default'].createElement(StyledImageLogo, { src: "/images/lyd_logo.png", alt: "logo header", width: 50, height: 50 }),
                React__default['default'].createElement(StyledTitle, { isDark: isDark }, "LydiaFinance")),
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, lydPriceUsd: lydPriceUsd, pushNav: setIsPushed, links: links }),
...
exports.LydiaRoundIcon = Icon$R;
exports.LydiasIcon = Icon$S;
